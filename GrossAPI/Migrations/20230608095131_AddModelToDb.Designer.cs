...
namespace GrossAPI.Migrations
{
    ...
    [Migration("20230608095131_AddModelToDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GrossAPI.Models.Responses", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OrdersServices", b =>
                {
                    b.Property<Guid>("OrdersId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GrossAPI.Models.Responses", b =>
                {
                    b.HasOne("GrossAPI.Models.Orders", "Order")
                        .WithMany()
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GrossAPI.Models.Services", "Service")
                        .WithMany()
            ...
            modelBuilder.Entity("OrdersServices", b =>
                {
                    b.HasOne("GrossAPI.Models.Orders", null)
                        .WithMany()
                        .HasForeignKey("OrdersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GrossAPI.Models.Services", null)
                        .WithMany()
